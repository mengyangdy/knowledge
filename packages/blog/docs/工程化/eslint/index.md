...
To check syntax, find problems, and enforce code style //检查语法找到错误并且强制执行
...
（6）How would you like to define a style for your project? //喜欢用什么风格的代码?
Use a popular style guide //使用一个市面上主流的风格
Answer questions about your style //通过问题回答 形成一个风格

（7）Which style guide do you want to follow? //想使用那种风格的？
